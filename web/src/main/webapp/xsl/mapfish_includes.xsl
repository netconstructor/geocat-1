...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="mapfish_includes">
        <link rel="stylesheet" type="text/css"
              href="{/root/gui/url}/scripts/mfbase/ext/resources/css/ext-all.css"/>
        <link rel="stylesheet" type="text/css"
        ...
        <link href="{/root/gui/url}/scripts/mfbase/mapfish/mapfish.css" type="text/css" rel="stylesheet"/>
        <style type="text/css">
            ...
            .zoomin {
              background-image:url(<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/img/icon_zoomin.png) !important;
              height:20px !important;
              width:20px !important;
            }
            .zoomout {
              background-image:url(<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/img/icon_zoomout.png) !important;
              height:20px !important;
              width:20px !important;
            }
            .zoomfull {
              background-image:url(<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/img/icon_zoomfull.png) !important;
              height:20px !important;
              width:20px !important;
            }
            .pan {
              background-image:url(<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/img/icon_pan.png) !important;
              height:20px !important;
              width:20px !important;
            }
            .selectBbox {
              background-image:url(<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/img/draw_polygon_off.png) !important;
              height:20px !important;
              width:20px !important;
            }
            .drawPolygon {
            ...
            .clearPolygon {
              background-image:url(<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/img/draw_polygon_clear_off.png) !important;
              height:20px !important;
              width:20px !important;
            }
            .layerTreeButton {
        ...
        <script type="text/javascript">
            window.gMfLocation = '<xsl:value-of select="/root/gui/url"/>/scripts/mfbase/mapfish/';
        </script>
        <xsl:choose>
            <xsl:when test="/root/request/debug">
                <script src="{/root/gui/url}/scripts/mfbase/ext/adapter/ext/ext-base.js" type="text/javascript"/>
                <script src="{/root/gui/url}/scripts/mfbase/ext/ext-all-debug.js" type="text/javascript"/>
                <script src="{/root/gui/url}/scripts/mfbase/openlayers/lib/OpenLayers.js" type="text/javascript"/>
                <script src="{/root/gui/url}/scripts/mfbase/mapfish/MapFish.js" type="text/javascript"/>
            </xsl:when>
            <xsl:otherwise>
                <!--<script src="{/root/gui/url}/scripts/mfbase/ext/adapter/ext/ext-base.js" type="text/javascript"/>-->
                ...
                <script src="{/root/gui/url}/scripts/mapfishIntegration/MapFish.js" type="text/javascript"/>
            </xsl:otherwise>
        </xsl:choose>
        <xsl:if test="/root/gui/language!='eng'">
            <script type="text/javascript"
                src="{/root/gui/url}/scripts/mfbase/openlayers/lib/OpenLayers/Lang/{/root/gui/strings/language}.js"/>
            <script type="text/javascript"
                src="{/root/gui/url}/scripts/mfbase/mapfish/lang/{/root/gui/strings/language}.js"/>
        </xsl:if>
        <script type="text/javascript"
