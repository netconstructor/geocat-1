...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Template use to return a localised URL
        
        eg.
        <gmd:linkage xsi:type="che:PT_FreeURL_PropertyType">
          <gmd:URL>http://myUrlInDefaultMetadataLanguage</gmd:URL>
          <che:PT_FreeURL>
            <che:URLGroup>
              <che:LocalisedURL locale="#DE">http://myUrlInDe</che:LocalisedURL>
            </che:URLGroup>
          </che:PT_FreeURL>
        </gmd:linkage>
    -->
    <xsl:template name="localisedUrl" mode="localisedUrl" match="gmd:linkage">
