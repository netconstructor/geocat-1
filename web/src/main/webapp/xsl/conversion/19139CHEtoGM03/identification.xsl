...
<xsl:stylesheet version="1.0"
                ...
                exclude-result-prefixes="che gco gmd srv">
    ...
    <xsl:template mode="DataIdentification" match="che:CHE_MD_DataIdentification|gmd:MD_DataIdentification">
        <GM03_2Comprehensive.Comprehensive.MD_DataIdentification TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:aggregationInfo">
        <GM03_2Comprehensive.Comprehensive.aggregationInfo_MD_Identification TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:MD_AggregateInformation">
        <aggregationInfo REF="?">
            <GM03_2Comprehensive.Comprehensive.MD_AggregateInformation TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:resourceSpecificUsage">
        <GM03_2Comprehensive.Comprehensive.MD_Usage TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:userContactInfo">
        <GM03_2Comprehensive.Comprehensive.MD_UsageuserContactInfo TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:graphicOverview">
        <GM03_2Comprehensive.Comprehensive.MD_BrowseGraphic TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="che:revision">
        <GM03_2Comprehensive.Comprehensive.revisionMD_Identification TID="x{generate-id(.)}">
            <revision REF="?">
                <xsl:apply-templates mode="DataIdentification"/>
            </revision>
            <BACK_REF name="MD_Identification"/>
    ...
    <xsl:template mode="DataIdentification" match="che:CHE_MD_Revision">
        <GM03_2Comprehensive.Comprehensive.MD_Revision TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:resourceConstraints|srv:restrictions">
        <GM03_2Comprehensive.Comprehensive.resourceConstraintsMD_Identification TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:MD_SecurityConstraints">
        <GM03_2Comprehensive.Comprehensive.MD_SecurityConstraints TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="che:CHE_MD_LegalConstraints|gmd:MD_LegalConstraints">
        <GM03_2Comprehensive.Comprehensive.MD_LegalConstraints TID="x{generate-id(.)}">
            <xsl:apply-templates mode="groupText" select=".">
                <xsl:with-param name="element">useLimitation</xsl:with-param>
            </xsl:apply-templates><!--
    ...
    <xsl:template mode="DataIdentification" match="gmd:MD_Constraints">
        <GM03_2Comprehensive.Comprehensive.MD_Constraints TID="x{generate-id(.)}">
            <xsl:apply-templates mode="groupText" select=".">
                <xsl:with-param name="element">useLimitation</xsl:with-param>
            </xsl:apply-templates>
    ...
    <xsl:template mode="DataIdentification" match="gmd:MD_Resolution">
        <GM03_2Core.Core.MD_Resolution TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:MD_RepresentativeFraction">
        <GM03_2Core.Core.MD_RepresentativeFraction TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:descriptiveKeywords">
        <GM03_2Core.Core.descriptiveKeywordsMD_Identification TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:MD_Keywords">
        <GM03_2Core.Core.MD_Keywords TID="x{generate-id(.)}">
    ...
    <xsl:template mode="DataIdentification" match="gmd:resourceFormat">
        <GM03_2Comprehensive.Comprehensive.resourceFormatMD_Identification TID='x{generate-id(.)}'>
            <resourceFormat REF='?'>
                <xsl:apply-templates mode="DataIdentification"/>
            </resourceFormat>
            <BACK_REF name="MD_Identification"/>
    ...
    <xsl:template mode="DataIdentification" match="gmd:pointOfContact">
        <GM03_2Core.Core.MD_IdentificationpointOfContact TID="x{generate-id(.)}">
            <pointOfContact REF="?">
    ...
    <xsl:template mode="DataIdentification" match="gmd:identifier">
        <GM03_2Comprehensive.Comprehensive.CI_Citationidentifier TID="x{generate-id(.)}">
            <identifier REF='?'>
                <xsl:choose>
    ...
    <xsl:template mode="DataIdentification" match="che:CHE_SV_ServiceIdentification">
        <GM03_2Comprehensive.Comprehensive.SV_ServiceIdentification TID="x{generate-id(.)}">
            <xsl:call-template name="dataIdentification" />
            ...
            <xsl:apply-templates mode="text" select="srv:operatesOn"/>
            <xsl:apply-templates mode="DataIdentification" select="srv:coupledResource"/>
            <xsl:apply-templates mode="DataIdentification" select="srv:serviceType"/>
            <xsl:apply-templates mode="DataIdentification" select="srv:containsOperation"/>
    ...
    <xsl:template mode="DataIdentification" match="srv:coupledResource">
            <xsl:apply-templates mode="text" select="srv:identifier"/>
            <xsl:apply-templates mode="text" select="srv:operationName"/>
            <xsl:apply-templates mode="text" select="gco:scopeName"/>
    </xsl:template>


    <xsl:template mode="DataIdentification" match="srv:extent">
        <GM03_2Comprehensive.Comprehensive.extentSV_ServiceIdentification TID="x{generate-id(.)}">
        <extent REF="?">
