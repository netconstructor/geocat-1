...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.MD_DataIdentification|int:GM03_2Core.Core.MD_DataIdentification">
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.SV_ServiceIdentification">
    ...
    <xsl:template mode="DataIdentification" match="int:serviceType">
        <srv:serviceType>
            <gco:LocalName><xsl:value-of select="int:GM03_2Comprehensive.Comprehensive.gml_CodeType/int:code"/></gco:LocalName>
            <xsl:if test="int:GM03_2Comprehensive.Comprehensive.gml_CodeType/int:codeSpace">
                <gml:codeSpace><xsl:value-of select="int:GM03_2Comprehensive.Comprehensive.gml_CodeType/int:codeSpace"/></gml:codeSpace>
            </xsl:if>
        </srv:serviceType>
    </xsl:template>
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.resourceConstraintsMD_Identification">
        <gmd:resourceConstraints>
            <xsl:apply-templates mode="ConstsTypes"/>
        </gmd:resourceConstraints>
    </xsl:template>
    <xsl:template mode="DataIdentification" match="int:GM03_2Core.Core.descriptiveKeywordsMD_Identification">
    ...
    <xsl:template name="dataIdentification">
        ...
        <xsl:for-each select="int:status">
            <gmd:status>
                <gmd:MD_ProgressCode codeList="./resources/codeList.xml#MD_ProgressCode" codeListValue="{int:GM03_2Core.Core.MD_ProgressCode_/int:value}"/>
            </gmd:status>
        </xsl:for-each>
        <xsl:for-each select="int:GM03_2Core.Core.MD_IdentificationpointOfContact">
            <gmd:pointOfContact>
                <xsl:apply-templates mode="RespParty" select="."/>
            </gmd:pointOfContact>
        </xsl:for-each>
        <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.MD_MaintenanceInformation">
            <gmd:resourceMaintenance>
                <xsl:apply-templates select="." mode="MaintenanceInfo"/>
            </gmd:resourceMaintenance>
        </xsl:for-each>
        <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.MD_BrowseGraphic">
            <gmd:graphicOverview>
                <xsl:apply-templates  mode="DataIdentification" select="."/>
            </gmd:graphicOverview>
        </xsl:for-each>
        <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.resourceFormatMD_Identification">
            <gmd:resourceFormat>
                <xsl:apply-templates mode="ResourceFormat"/>
            </gmd:resourceFormat>
        </xsl:for-each>
        <xsl:for-each select="int:GM03_2Core.Core.descriptiveKeywordsMD_Identification[$srv=false()]">
            <gmd:descriptiveKeywords>
                <xsl:apply-templates mode="DescriptiveKeyword"/>
            </gmd:descriptiveKeywords>
        </xsl:for-each>

        <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.MD_Usage">
                <xsl:apply-templates mode="DataIdentification" select="."/>
        </xsl:for-each>


        <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.resourceConstraintsMD_Identification[$srv=false()]">
            <gmd:resourceConstraints>
                <xsl:apply-templates mode="ConstsTypes"/>
            </gmd:resourceConstraints>
        </xsl:for-each>

        <xsl:apply-templates mode="DataIdentification" select="int:GM03_2Comprehensive.Comprehensive.aggregationInfo_MD_Identification"/>
        ...
        <xsl:for-each select="int:spatialRepresentationType">
            <gmd:spatialRepresentationType>
                <gmd:MD_SpatialRepresentationTypeCode codeList="./resources/codeList.xml#MD_SpatialRepresentationTypeCode"
                                                  codeListValue="{int:GM03_2Core.Core.MD_SpatialRepresentationTypeCode_/int:value}"/>
            </gmd:spatialRepresentationType>
        </xsl:for-each>
        <xsl:for-each select="int:GM03_2Core.Core.MD_Resolution/int:distance">
        ...
        <xsl:for-each select="int:GM03_2Core.Core.MD_Resolution/int:equivalentScale">
            <gmd:spatialResolution>
                <gmd:MD_Resolution>
                    <xsl:apply-templates mode="DataIdentification" select="."/>
                </gmd:MD_Resolution>
        ...
        <xsl:for-each select="int:characterSet">
            <gmd:characterSet>
                <gmd:MD_CharacterSetCode codeList="./resources/codeList.xml#MD_CharacterSetCode" codeListValue="{int:GM03_2Core.Core.MD_CharacterSetCode_/int:value}"/>
            </gmd:characterSet>
        </xsl:for-each>
        ...
        <xsl:for-each select="int:GM03_2Core.Core.EX_Extent[$srv=false()]">
            <xsl:apply-templates mode="Extent" select="."/>
        </xsl:for-each>
        ...
        <xsl:for-each select="int:GM03_2Comprehensive.Comprehensive.revisionMD_Identification/int:revision">
            <che:revision>
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.aggregationInfo_MD_Identification">
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.MD_AggregateInformation">
        <gmd:MD_AggregateInformation>
            <xsl:apply-templates mode="DataIdentification" select="int:GM03_2Comprehensive.Comprehensive.CI_Citation"/>
    ...
    <xsl:template mode="DataIdentification" match="int:aggregateDataSetIdentifier">
        <gmd:aggregateDataSetIdentifier>
            <xsl:apply-templates mode="Identifier" select="int:GM03_2Core.Core.MD_Identifier"/>
        </gmd:aggregateDataSetIdentifier>
    </xsl:template>

    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.CI_Citation">
        <gmd:aggregateDataSetName>
            <xsl:apply-templates mode="Citation" select="."/>
        </gmd:aggregateDataSetName>
    </xsl:template>

    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.MD_Usage">
        <gmd:resourceSpecificUsage>
            <gmd:MD_Usage>
                ...
                <xsl:apply-templates mode="DataIdentification" select="int:GM03_2Comprehensive.Comprehensive.MD_UsageuserContactInfo"/>
            </gmd:MD_Usage>
        </gmd:resourceSpecificUsage>
    </xsl:template>

    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.MD_UsageuserContactInfo">
        <gmd:userContactInfo>
            <xsl:apply-templates mode="RespParty" select="."/>
        </gmd:userContactInfo>
    </xsl:template>

    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.MD_BrowseGraphic">
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Core.Core.MD_RepresentativeFraction">
    ...
    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.MD_MaintenanceInformation">
        <gmd:resourceMaintenance>
            <xsl:apply-templates select="." mode="MaintenanceInfo"/>
        </gmd:resourceMaintenance>
    </xsl:template>

    <xsl:template mode="DataIdentification" match="int:GM03_2Core.Core.MD_IdentificationpointOfContact">
        <gmd:pointOfContact>
            <xsl:apply-templates mode="RespParty" select="."/>
        </gmd:pointOfContact>
    </xsl:template>

    <xsl:template mode="DataIdentification" match="int:GM03_2Comprehensive.Comprehensive.resourceFormatMD_Identification">
        <gmd:resourceFormat>
            <xsl:apply-templates mode="ResourceFormat"/>
        </gmd:resourceFormat>
    </xsl:template>

    <xsl:template mode="Revision" match="int:GM03_2Comprehensive.Comprehensive.MD_Revision">
        <che:CHE_MD_Revision gco:isoType="gmd:MD_Revision">
            <xsl:for-each select="int:revisionScope">
                <che:revisionScope>
                    <xsl:apply-templates mode="MaintenanceInfo" select="int:GM03_2Core.Core.MD_ScopeCode_"/>
                </che:revisionScope>
            </xsl:for-each>
            ...
            <xsl:for-each select="int:revisionExtent">
                <che:revisionExtent>
                    <xsl:apply-templates mode="Extent" select="int:GM03_2Core.Core.EX_Extent"/>
                </che:revisionExtent>
            </xsl:for-each>
    ...
    <xsl:template mode="DescriptiveKeyword" match="int:GM03_2Core.Core.MD_Keywords">
        <gmd:MD_Keywords>
    ...
    <xsl:template mode="ConstsTypes" match="int:GM03_2Comprehensive.Comprehensive.MD_LegalConstraints">
    ...
    <xsl:template mode="ConstsTypes" match="int:useConstraints">
        <gmd:useConstraints>
            <gmd:MD_RestrictionCode codeList="./resources/codeList.xml#MD_RestrictionCode" codeListValue="{int:GM03_2Comprehensive.Comprehensive.MD_RestrictionCode_/int:value}" />
        </gmd:useConstraints>
    </xsl:template>
    ...
    <xsl:template mode="ConstsTypes" match="int:GM03_2Comprehensive.Comprehensive.MD_SecurityConstraints">
    ...
    <xsl:template mode="ConstsTypes" match="int:GM03_2Comprehensive.Comprehensive.MD_Constraints">
    ...
    <xsl:template mode="ResourceFormat" match="int:GM03_2Comprehensive.Comprehensive.MD_Format|int:GM03_2Core.Core.MD_Format">
        ...
        <gmd:MD_Format>
            ...
            <xsl:if test="$loop!='0'">
                ...
                <xsl:for-each select="/int:GM03_2Comprehensive.Comprehensive/int:GM03_2Comprehensive.Comprehensive.formatDistributordistributorFormat[int:distributorFormat/@REF=$myTID]">
