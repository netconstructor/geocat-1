                    ...
                    <table width="100%">
                        <tr>
                            ...
                            <td align="right" class="padded-content" height="16" nowrap="nowrap">
                                <a class="noprint" href="{/root/gui/locService}/xml.metadata.get?id={geonet:info/id}" target="_blank" title="Download raw xml metadata">
                                    <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/download.png" alt="Native Version" title="Download raw xml metadata" />
                                </a>
                                <xsl:choose>
                                    <xsl:when test="contains(geonet:info/schema,'dublin-core')">
                                            <a class="noprint" href="{/root/gui/locService}/dc.xml?id={geonet:info/id}" target="_blank" title="Download Dublin Core metadata in XML">
                                                <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/xml.png" alt="Dublin Core XML" title="Save Dublin Core metadata as XML" border="0"/>
                                            </a>
                                    </xsl:when>
                                    <xsl:when test="contains(geonet:info/schema,'fgdc-std')">
                                            <a class="noprint" href="{/root/gui/locService}/fgdc.xml?id={geonet:info/id}" target="_blank" title="Download FGDC metadata in XML">
                                                <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/xml.png" alt="FGDC XML" title="Save FGDC metadata as XML" border="0"/>
                                            </a>
                                    </xsl:when>
                                    <xsl:when test="contains(geonet:info/schema,'iso19115')">
                                            <a class="noprint" href="{/root/gui/locService}/iso19115to19139.xml?id={geonet:info/id}" target="_blank" title="Save ISO19115/19139 metadata as XML">
                                                <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/xml.png" alt="IISO19115/19139 XML" title="Save ISO19115/19139 metadata as XML" border="0"/>
                                            </a>
                                            <a href="{/root/gui/locService}/iso_arccatalog8.xml?id={geonet:info/id}" target="_blank" title="Download ISO19115 metadata in XML for ESRI ArcCatalog">
                                                <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/ac.png" alt="ISO19115 XML for ArcCatalog" title="Save ISO19115 metadata in XML for ESRI ArcCatalog" border="0"/>
                                            </a>
                                    </xsl:when>
                                    <xsl:when test="contains(geonet:info/schema,'iso19139')">
                                            <a class="noprint" href="{/root/gui/locService}/iso19139.xml?id={geonet:info/id}" target="_blank" title="Download ISO19115/19139 metadata in XML">
                                                <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/xml.png" alt="ISO19115/19139 XML" title="Save ISO19115/19139 metadata as XML" border="0"/>
                                            </a>
                                        ...
                                        <xsl:choose>
                                            <xsl:when test="geonet:info/schema='iso19139.che'">
                                                <a href="{/root/gui/locService}/gm03.xml?id={geonet:info/id}" target="_blank" title="Download GM03"><!-- TODO : Translate -->
                                                    <img style="border:0px;max-height:16px;" src="{/root/gui/url}/images/xml_gm03.png" alt="GM03 XML" title="Save GM03" border="0"/>
                                                </a>
                                            </xsl:when>
                                        </xsl:choose>
                                ...
                                <a id="permalink_{$fileId}" onClick="permlink('{$serverUrl}/metadata.show?fileIdentifier={$fileId}&amp;currTab=simple') " target="_{$fileId}" title="Permalink"><!-- TODO : Translate -->
