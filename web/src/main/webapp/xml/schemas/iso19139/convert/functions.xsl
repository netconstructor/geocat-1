...
<!-- ==================================================================== -->
    ...
    <xsl:template name="defaultTitle">
        ...
        <xsl:choose>
        <xsl:when    test="string-length(/*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:identificationInfo/*[name(.)='gmd:MD_DataIdentification' or @gco:isoType='gmd:MD_DataIdentification']/gmd:citation//gmd:title//gmd:LocalisedCharacterString[@locale=$poundLangId]) != 0">
            <xsl:value-of select="string(/*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:identificationInfo/*[name(.)='gmd:MD_DataIdentification' or @gco:isoType='gmd:MD_DataIdentification']/gmd:citation//gmd:title//gmd:LocalisedCharacterString[@locale=$poundLangId])"></xsl:value-of>
        </xsl:when>
