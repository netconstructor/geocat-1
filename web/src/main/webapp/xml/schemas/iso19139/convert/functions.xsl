...
<!-- ==================================================================== -->
    ...
    <xsl:template name="defaultTitle">
        ...
        <xsl:when    test="string-length(/*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:identificationInfo/gmd:citation//gmd:title/gco:CharacterString[1]) != 0">
            <xsl:value-of select="string(/*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:identificationInfo/gmd:citation//gmd:title/gco:CharacterString[1])"></xsl:value-of>
        </xsl:when>
        <xsl:otherwise>
            <xsl:value-of select="string((/*[name(.)='gmd:MD_Metadata' or @gco:isoType='gmd:MD_Metadata']/gmd:identificationInfo/gmd:citation//gmd:title//gmd:LocalisedCharacterString))"></xsl:value-of>
        </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
