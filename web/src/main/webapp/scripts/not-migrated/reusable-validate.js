...
function currentPage(){
    return Ext.query("tr.blue-content").first().id.substring(4);
...
function createGrid(){
    ...
    var grid = new xg.GridPanel({
        ...
        cm: new xg.ColumnModel([
            ...
            {id:'desc',header: "Data", width: 40, sortable: true, dataIndex: 'desc'},
            {id:'date',header: "Date", width: 40, sortable: true, dataIndex: 'date'}
        ]),
        viewConfig: {
            forceFit:true
        },
