...
operations[i++] = [ 'csw-GetRecordsNoFilterGM03Record',
            		'csw-GetRecords | no filter | outputSchema: GM03_2Record', '' ];
operations[i++] = [
...
operations[i++] = [ 'csw-GetRecordByIdGM03Record',
            		'csw-GetRecordById | outputSchema: GMM03_2Record', '' ];
// GetRecordById ------------- END -- //
// GetDomain ------------- START -- //
