...
ker.include('harvesting/cgp/cgp.js');
...
function update()
{
    ...
    // geocat RT#13917
    // Selects the first item (value 'none') of the group hidden multiselect
    if ($('gn.categories') && $('gn.categories').options.length) {
        $('gn.categories').options[0].selected = 'selected';
    }
