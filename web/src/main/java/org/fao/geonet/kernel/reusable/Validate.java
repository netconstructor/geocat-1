...
public class Validate implements Service
{
    ...
    public Element exec(Element params, ServiceContext context) throws Exception
    {
        ...
        Log.debug(ReusableObjectLogger.REUSABLE_LOGGER_ID, "Starting to validate following reusable objects: " + page
                + " \n(" + Arrays.toString(ids) + ")");
        ...
        Log.info(ReusableObjectLogger.REUSABLE_LOGGER_ID, "Successfully validated following reusable objects: " + page
                + " \n(" + Arrays.toString(ids) + ")");
