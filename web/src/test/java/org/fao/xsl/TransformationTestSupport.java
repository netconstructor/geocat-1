...
public final class TransformationTestSupport
{
    ...
    static File transformIsoToGM03(File src, File outputDir) throws SAXException, TransformerConfigurationException,
            FlattenerException, IOException, TransformerException {
        return transformIsoToGM03(src,outputDir,true);
    }
    static File transformIsoToGM03(File src, File outputDir, boolean testValidity) throws SAXException, TransformerConfigurationException,
            FlattenerException, IOException, TransformerException
    {
        try {
    ...
    static File copy(File in, File out)
        throws IOException
    {
    ...
    public static final File     isoXsd              = new File(geonetworkWebapp, "xml/schemas/iso19139.che/schema.xsd");
